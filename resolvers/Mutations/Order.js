...
export async function saveOrder(parent, args, context, info) {
    ...
    var address = await context.prisma.districtsOnUsers.findUnique({ where: { id: args.districtsOnUsersId },})
    ...
    const data= {firstname: user.firtname, lastname: user.lastname, email: user.email, phonenumber: user.phonenumber,
                 userId: user.id, line1: address.line1, line2: address.line2, districtId: address.districtId}
