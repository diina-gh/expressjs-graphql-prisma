...
export async function saveImage(parent, args, context, info) {
  ...
  const date = new Date()
  var data = {url: args.url, imageref: args.imageref, isDefault: args.isDefault, productId: args.productId, optionId: args.optionId, brandId: args.brandId, categoryId: args.categoryId, userId:args.userId}
