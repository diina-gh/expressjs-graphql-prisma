export async function saveCountry(parent, args, context, info) {
  ...
  if(args.iso3 == null || args.iso3.length != 3) return { __typename: "InputError", message: `Veuillez donner le code iso3 (le code iso3 d'un pays doit comporter 3 charactère)`,};
  if(args.isoNum == null || args.isoNum.length > 3) return { __typename: "InputError", message: `Veuillez donner le code iso numérique (le code iso numérique doit comporter au maximum 3 charactère)`,};
